...
export function MemberDirectoryPanel({ inline = false, onClose = () => {} }: { inline?: boolean; onClose?: () => void }) {
  ...
  return (
    <div className={inline ? "h-full flex flex-col bg-white min-h-0 w-full" : "min-h-screen bg-gray-50 flex flex-col"}>
      {/* Header */}
      <div className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between sticky top-0 z-20 shrink-0">
