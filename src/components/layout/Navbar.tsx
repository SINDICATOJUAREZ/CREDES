    ...
    <nav className="fixed top-0 left-0 right-0 h-16 bg-white/80 backdrop-blur-md border-b border-gray-100 z-50 flex items-center justify-between px-8">
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:block">
          <h1 className="text-xl font-black text-gray-900 leading-none">SICSUTSMBJ</h1>
      ...
      <div className="flex items-center gap-6">
        ...
        <button className="flex items-center gap-2 px-4 py-2 bg-gray-900 text-white rounded-lg text-sm font-bold hover:bg-gray-800 transition-all active:scale-95">
